...
/***/ function(module, exports, __webpack_require__) {
	...
	// custom directives
	myApp.directive('approveReview', __webpack_require__(8));
	myApp.directive('batchApprove', __webpack_require__(9));
	myApp.directive('starRating', __webpack_require__(10));
	myApp.directive('basket', __webpack_require__(11));
	myApp.directive('dashboardSummary', __webpack_require__(12));
	myApp.directive('zoomInModal', __webpack_require__(14));
	...
	// custom states (pages)
	myApp.config(['$stateProvider', __webpack_require__(15)]);
	
	myApp.config(['NgAdminConfigurationProvider', function (nga) {
	    // create the admin application
	    var admin = nga.application('Ecommerce').baseApiUrl('http://127.0.0.1:8000/api/v1/');
	
	    // add entities
	    admin.addEntity(nga.entity('addresses'));
	    admin.addEntity(nga.entity('orderedItems').url(function (entityName, viewType, identifierValue, identifierName) {
	        //      return '/orders-items/' + entityName + '_' + viewType + '?' + identifierName + '=' + identifierValue; // Can be absolute or relative
	        return 'orders-items'; // Can be absolute or relative
	    }));
	    ...
	    admin.dashboard(__webpack_require__(26)(nga, admin));
	...
	/*myApp.config(['RestangularProvider', function(RestangularProvider){
	    //TODO: Reemplazar $location por $state
	    // $location y $state no funcionan en .config() , solo en .run()
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _dashboardSummaryHtml = __webpack_require__(13);
	...
	function dashboardSummary(Restangular) {
	    ...
	    return {
	        ...
	        controller: function controller($scope) {
	            ...
	            Restangular.all('products-variants').getList({ range: '[1,100]', filter: '{stock_lte: 18}' }).then(function (products) {
	                $scope.stats.products_low_stock = products.data.reduce(function (nb) {
	                    return ++nb;
	                }, 0);
	            });
	            Restangular.all('users').getList().then(function (users) {
	                $scope.stats.users = users.data.reduce(function (nb) {
	                    return ++nb;
	                }, 0);
	            });
	            Restangular.all('orders').getList({ range: '[1,100]', filter: '{"status":"payment-pending"}' }).then(function (orders) {
	                $scope.stats.pending_orders = orders.data.reduce(function (nb) {
	                    return ++nb;
	                }, 0);
	            });
	        },
...
/***/ function(module, exports) {
	...
	module.exports = "<div class=\"row\">\n    <div class=\"col-lg-12\">\n        <uib-alert type=\"info\" close=\"dismissAlert()\" ng-show=\"!has_seen_alert\">\n            Bienvenido a Context Ecommerce\n        </uib-alert>\n    </div>\n</div>\n<div class=\"row\">\n    <div class=\"col-lg-3\">\n        <div class=\"panel panel-primary\">\n            <div class=\"panel-heading\">\n                <div class=\"row\">\n                    <div class=\"col-xs-3\">\n                        <i class=\"fa fa-question-circle fa-5x\"></i>\n                    </div>\n                    <div class=\"col-xs-9 text-right\">\n                        <div class=\"huge\">{{ stats.products_low_stock | number:0 }}</div>\n                        <div>Prod. con bajo stock</div>\n                    </div>\n                </div>\n            </div>\n            <a ui-sref=\"list({entity:'productsVariants',search:{stock_lte:18}})\">\n                <div class=\"panel-footer\">\n                    <span class=\"pull-left\">Ver detalles</span>\n                    <span class=\"pull-right\"><i class=\"fa fa-arrow-circle-right\"></i></span>\n                    <div class=\"clearfix\"></div>\n                </div>\n            </a>\n\n        </div>\n    </div>\n    <div class=\"col-lg-3\">\n        <div class=\"panel panel-green\">\n            <div class=\"panel-heading\">\n                <div class=\"row\">\n                    <div class=\"col-xs-3\">\n                        <i class=\"fa fa-cart-arrow-down fa-5x\"></i>\n                    </div>\n                    <div class=\"col-xs-9 text-right\">\n                        <div class=\"huge\">{{ stats.pending_orders }}</div>\n                        <div>Ordenes pendientes</div>\n                    </div>\n                </div>\n            </div>\n            <a ui-sref=\"list({entity:'orders',search:{status:'payment-pending'}})\">\n                <div class=\"panel-footer\">\n                    <span class=\"pull-left\">Ver detalles</span>\n                    <span class=\"pull-right\"><i class=\"fa fa-arrow-circle-right\"></i></span>\n                    <div class=\"clearfix\"></div>\n                </div>\n            </a>\n        </div>\n    </div>\n    <div class=\"col-lg-3\">\n        <div class=\"panel panel-yellow\">\n            <div class=\"panel-heading\">\n                <div class=\"row\">\n                    <div class=\"col-xs-3\">\n                        <i class=\"fa fa-users fa-5x\"></i>\n                    </div>\n                    <div class=\"col-xs-9 text-right\">\n                        <div class=\"huge\">{{ stats.users }}</div>\n                        <div>Clientes</div>\n                    </div>\n                </div>\n            </div>\n            <a ui-sref=\"list({entity:'users'})\">\n                <div class=\"panel-footer\">\n                    <span class=\"pull-left\">Ver detalles</span>\n                    <span class=\"pull-right\"><i class=\"fa fa-arrow-circle-right\"></i></span>\n                    <div class=\"clearfix\"></div>\n                </div>\n            </a>\n        </div>\n    </div>\n    <div class=\"col-lg-3\">\n        <div class=\"panel panel-red\">\n            <div class=\"panel-heading\">\n                <div class=\"row\">\n                    <div class=\"col-xs-3\">\n                        <i class=\"fa fa-shopping-basket fa-5x\"></i>\n                    </div>\n                    <div class=\"col-xs-9 text-right\">\n                        <div class=\"huge\">+</div>\n                        <div>Crear pedido</div>\n                    </div>\n                </div>\n            </div>\n            <a ui-sref=\"list({entity:'users',search:{has_ordered:true}})\">\n                <div class=\"panel-footer\">\n                    <span class=\"pull-left\">Ir</span>\n                    <span class=\"pull-right\"><i class=\"fa fa-arrow-circle-right\"></i></span>\n                    <div class=\"clearfix\"></div>\n                </div>\n            </a>\n        </div>\n    </div>\n</div>\n";
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _segmentsTemplateHtml = __webpack_require__(16);
	
	var _segmentsTemplateHtml2 = _interopRequireDefault(_segmentsTemplateHtml);
	
	var _segments = __webpack_require__(17);
...
/***/ function(module, exports) {
	...
	exports['default'] = function (nga, admin) {
	    ...
	    addresses.listView().title('Addresses').fields([nga.field('id'), nga.field('first_name'), nga.field('last_name'), nga.field('street_address_1')]).filters([nga.field('q', 'template').label('').pinned(true).template('<div class="input-group"><input type="text" ng-model="value" placeholder="Search" class="form-control"></input><span class="input-group-addon"><i class="glyphicon glyphicon-search"></i></span></div>'), nga.field('user', 'reference').label('User').targetEntity(admin.getEntity('users')).targetField(nga.field('username'))]);
...
/***/ function(module, exports) {
	...
	exports['default'] = function (nga, admin) {
	    ...
	    orderedItems.listView().fields([nga.field('id'), nga.field('product_name')]).listActions(['edit', 'delete']);
	    orderedItems.creationView().fields([nga.field('id').editable(false), nga.field('product_name').editable(false)]);
	    orderedItems.editionView().fields(orderedItems.creationView().fields());
...
/***/ function(module, exports) {
	...
	exports["default"] = function (nga, admin) {
	    ...
	    orders.listView().fields([nga.field('id'), nga.field('created'), nga.field('status')]).filters([nga.field('status', 'choice').choices(order_status_choices)]).listActions(['edit']).batchActions([]);
	    orders.editionView().actions(['show', 'list']).fields([nga.field('created').editable(false), nga.field('status', 'choice').choices(order_status_choices), nga.field('user').editable(false),
	    //            nga.field('anonymous_user_email').editable(false),
	    nga.field('billing_address', 'reference').label('Billing Address').targetEntity(admin.getEntity('addresses')).targetField(nga.field('last_name').map(function (v, e) {
	        return e.first_name + ' ' + e.last_name + ': ' + e.street_address_1;
	    })).editable(false), nga.field('shipping_address', 'reference').label('Shipping Address').targetEntity(admin.getEntity('addresses')).targetField(nga.field('last_name').map(function (v, e) {
	        return e.first_name + ' ' + e.last_name + ': ' + e.street_address_1;
	    })).editable(false),
	    //            nga.field('discount_amount').editable(false),
	    nga.field('total_net').editable(false), nga.field('items', 'referenced_list').editable(false).targetEntity(admin.getEntity('orderedItems')).targetReferenceField('order').targetFields([nga.field('product_sku').label('SKU'), nga.field('product_name').label('Product'), nga.field('quantity'), nga.field('unit_price_net'), nga.field('unit_price_gross')]).singleApiCall(function (ids) {
	        return { 'id': ids };
	    }), nga.field('payments', 'referenced_list').editable(false).targetEntity(admin.getEntity('payments')).targetReferenceField('order').targetFields([nga.field('id'), nga.field('created'), nga.field('variant'), nga.field('status'), nga.field('description'), nga.field('message'), nga.field('captured_amount'), nga.field('total')]).singleApiCall(function (ids) {
	        return { 'id': ids };
	    })]);
...
/***/ function(module, exports) {
	...
	exports['default'] = function (nga, admin) {
	    var customer = admin.getEntity('users');
	    customer.listView().title('Customers').fields([
	    ...
	    .label('User name').isDetailLink(true), nga.field('last_name', 'template') // use last_name for sorting
	    .label('Name').isDetailLink(true).template('{{ entry.values.first_name }} {{ entry.values.last_name }}'), nga.field('email', 'text') // use last_name for sorting
	    .label('Email'), nga.field('addresses', 'reference_many').targetEntity(nga.entity('addresses')).targetField(nga.field('id')).singleApiCall(function (ids) {
	        return { 'id': ids };
	    })]).listActions(['<ma-filtered-list-button entity-name="addresses" filter="{ user: entry.values.id }" size="xs" label="Related addresses"></ma-filtered-list-button>', 'edit', 'delete']);
	
	    customer.editionView().title('{{ entry.values.first_name }} {{ entry.values.last_name }}\'s details').fields([nga.field('first_name'), nga.field('last_name'), nga.field('email', 'email')]);
...
/***/ function(module, exports) {
	...
	exports['default'] = function (nga, admin) {
	    ...
	    categories.listView().fields([nga.field('id'), nga.field('name')]).listActions(['<ma-filtered-list-button entity-name="products" filter="{ category: entry.values.id }" size="xs" label="Related products"></ma-filtered-list-button>', 'edit', 'delete']);
...
/***/ function(module, exports) {
	...
	exports['default'] = function (nga, admin) {
	    ...
	    var productsVariants = admin.getEntity('productsVariants').label('productsVariants');
	    productsVariants.listView().title('All productsVariants').fields([nga.field('id', 'number'), nga.field('sku'), nga.field('name', 'text'), nga.field('product', 'reference').targetEntity(admin.getEntity('products')).targetField(nga.field('name')).singleApiCall(function (ids) {
	        return { 'id': ids };
	    }), nga.field('stock', 'number'), nga.field('price', 'number')]).filters([nga.field('stock_lte').label("Stock menor a")]);
	
	    //        .listActions(['edit', 'delete'])
	    productsVariants.creationView().title('Create new Product Variant').fields([nga.field('sku').validation({ required: true }), nga.field('name', 'text').validation({ required: true }), nga.field('product', 'reference').validation({ required: true }).targetEntity(admin.getEntity('products')).targetField(nga.field('name')).singleApiCall(function (ids) {
	        return { 'id': ids };
	    }), nga.field('price_override', 'number')]);
	
	    productsVariants.editionView().title('Edit Product Variant').fields([nga.field('sku').editable(false), nga.field('name', 'string').validation({ required: true }), nga.field('product', 'reference').targetEntity(admin.getEntity('products')).editable(false).targetField(nga.field('name')).singleApiCall(function (ids) {
	        return { 'id': ids };
	    }), nga.field('price_override')]);
	
	    // si le pongo tipo number no funciona
...
/***/ function(module, exports) {
	...
	exports['default'] = function (nga, admin) {
	    ...
	    var products = admin.getEntity('products').label('Products');
	    products.listView().title('All Products').fields([nga.field('id', 'number'), nga.field('name', 'text'), nga.field('price', 'number'), nga.field('categories', 'reference_many').targetEntity(nga.entity('categories')).targetField(nga.field('name')).singleApiCall(function (ids) {
	        return { 'id': ids };
	    })]).filters([nga.field('q', 'template').label('').pinned(true).template('<div class="input-group"><input type="text" ng-model="value" placeholder="Search" class="form-control"></input><span class="input-group-addon"><i class="glyphicon glyphicon-search"></i></span></div>'), nga.field('category', 'reference').label('Category').targetEntity(admin.getEntity('categories')).targetField(nga.field('name')), nga.field('price_gte', 'number').label('Min price'), nga.field('priceh_lte', 'number').label('Max price'), nga.field('stock_lte', 'template').label('Low stock').defaultValue(10)]).listActions(['edit', 'delete']);
	    products.creationView().title('Create new Product').fields([nga.field('name').validation({ required: true }), nga.field('categories', 'reference_many').targetEntity(nga.entity('categories')).targetField(nga.field('name')).attributes({ placeholder: 'Select some categories...' }).remoteComplete(true, {
	        refreshDelay: 300,
	        searchQuery: function searchQuery(search) {
	            return { q: search };
	        }
	    }), nga.field('price', 'float').validation({ required: true }), nga.field('weight', 'float').validation({ required: true }), nga.field('available_on', 'date'), nga.field('description', 'wysiwyg')]);
...
/***/ function(module, exports) {
	...
	exports['default'] = function (nga, admin) {
	    ...
	    payments.listView().fields([nga.field('id'), nga.field('status'), nga.field('total'), nga.field('orders', 'reference').targetEntity(nga.entity('orders')).targetField(nga.field('id')).singleApiCall(function (ids) {
	        return { 'id': ids };
	    })]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports['default'] = function (nga, admin) {
	    ...
	    return nga.dashboard().addCollection(nga.collection(admin.getEntity('productsVariants')).name('low_stock').title('Products low stock').fields([nga.field('id', 'number'), nga.field('sku'), nga.field('name', 'text'), nga.field('stock'), nga.field('product', 'reference').targetEntity(admin.getEntity('products')).targetField(nga.field('name')).singleApiCall(function (ids) {
	        return { 'id': ids };
	    })]).sortField('id').permanentFilters({ stock_lte: 18 }).sortDir('ASC').perPage(100)).addCollection(nga.collection(admin.getEntity('orders')).name('pending_orders').title('Pending orders').fields([nga.field('id'), nga.field('status'), nga.field('created')]).sortField('created').permanentFilters({ status: 'payment-pending' }).sortDir('DESC')).template('\n            <div class="row dashboard-starter"></div>\n            <dashboard-summary></dashboard-summary>\n        <div class="row dashboard-content">\n        <div class="col-lg-6">\n        <div class="panel panel-default">\n        <ma-dashboard-panel collection="dashboardController.collections.low_stock" entries="dashboardController.entries.low_stock" datastore="dashboardController.datastore"></ma-dashboard-panel>\n        </div>\n        </div>\n        <div class="col-lg-6">\n        <div class="panel panel-default">\n        <ma-dashboard-panel collection="dashboardController.collections.pending_orders" entries="dashboardController.entries.pending_orders" datastore="dashboardController.datastore"></ma-dashboard-panel>\n        </div>\n        </div>\n        </div>\n        ');
	};
...
/***/ function(module, exports) {
	...
	module.exports = "<nav class=\"navbar navbar-inverse\">\n    <div class=\"container-fluid\">\n        <div class=\"navbar-header\">\n            <button type=\"button\" class=\"navbar-toggle collapsed\" data-toggle=\"collapse\" data-target=\"#bs-example-navbar-collapse-2\">\n                <span class=\"sr-only\">Context Ecommerce</span>\n                <span class=\"icon-bar\"></span>\n                <span class=\"icon-bar\"></span>\n                <span class=\"icon-bar\"></span>\n            </button>\n            <a class=\"navbar-brand\" ng-click=\"appController.displayHome()\" href=\"#\">Ecommerce Admin</a>\n        </div>\n\n        <div class=\"collapse navbar-collapse\" id=\"bs-example-navbar-collapse-2\">\n            <!--<ul class=\"nav navbar-nav\">\n                <li class=\"active\"><a href=\"#\">Link <span class=\"sr-only\">(current)</span></a></li>\n                <li><a href=\"#\">Link</a></li>\n\n            </ul>-->\n            <form class=\"navbar-form navbar-left\" role=\"search\">\n                <div class=\"form-group\">\n                    <div class=\"input-group\">\n                        <div class=\"input-group-btn\">\n                            <button type=\"button\" class=\"btn btn-default dropdown-toggle\" data-toggle=\"dropdown\" aria-haspopup=\"true\" aria-expanded=\"false\">Producto <span class=\"caret\"></span></button>\n                            <ul class=\"dropdown-menu\">\n                                <li><a href=\"#\">Productos</a></li>\n                                <li><a href=\"#\">Clientes</a></li>\n                            </ul>\n                        </div><!-- /btn-group -->\n                        <input type=\"text\" class=\"form-control\" placeholder=\"Search\">\n                    </div><!-- /input-group -->\n\n                </div>\n                <button type=\"submit\" class=\"btn btn-default\"><i class=\"fa fa-search\" aria-hidden=\"true\"></i></button>\n            </form>\n            <ul class=\"nav navbar-nav navbar-right\">\n                <li class=\"dropdown\">\n                    <a href=\"#\" class=\"dropdown-toggle\" data-toggle=\"dropdown\" role=\"button\" aria-expanded=\"false\"><i class=\"fa fa-envelope fa-fw\"></i> <i class=\"fa fa-caret-down\"></i></a>\n                    <ul class=\"dropdown-menu dropdown-messages\" role=\"menu\">\n                        <li>\n                            <a href=\"#\">\n                                <div>\n                                    <strong>John Smith</strong>\n                                    <span class=\"pull-right text-muted\">\n                                        <em>Yesterday</em>\n                                    </span>\n                                </div>\n                                <div>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque eleifend...</div>\n                            </a>\n                        </li>\n                        <li class=\"divider\"></li>\n                        <li>\n                            <a href=\"#\">\n                                <div>\n                                    <strong>John Smith</strong>\n                                    <span class=\"pull-right text-muted\">\n                                        <em>Yesterday</em>\n                                    </span>\n                                </div>\n                                <div>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque eleifend...</div>\n                            </a>\n                        </li>\n                        <li class=\"divider\"></li>\n                        <li>\n                            <a href=\"#\">\n                                <div>\n                                    <strong>John Smith</strong>\n                                    <span class=\"pull-right text-muted\">\n                                        <em>Yesterday</em>\n                                    </span>\n                                </div>\n                                <div>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque eleifend...</div>\n                            </a>\n                        </li>\n                        <li class=\"divider\"></li>\n                        <li>\n                            <a class=\"text-center\" href=\"#\">\n                                <strong>Read All Messages</strong>\n                                <i class=\"fa fa-angle-right\"></i>\n                            </a>\n                        </li>\n                    </ul>\n                </li>\n                <li class=\"dropdown\">\n                    <a href=\"#\" class=\"dropdown-toggle\" data-toggle=\"dropdown\" role=\"button\" aria-expanded=\"false\"><i class=\"fa fa-bell fa-fw\"></i> <i class=\"fa fa-caret-down\"></i></a>\n                    <ul class=\"dropdown-menu dropdown-alerts\" role=\"menu\" style=\"width: 250px;\">\n                        <li>\n                            <a href=\"#\">\n                                <div>\n                                    <i class=\"fa fa-comment fa-fw\"></i> New Comment\n                                    <span class=\"pull-right text-muted small\">4 minutes ago</span>\n                                </div>\n                            </a>\n                        </li>\n                        <li class=\"divider\"></li>\n                        <li>\n                            <a href=\"#\">\n                                <div>\n                                    <i class=\"fa fa-twitter fa-fw\"></i> 3 New Followers\n                                    <span class=\"pull-right text-muted small\">12 minutes ago</span>\n                                </div>\n                            </a>\n                        </li>\n                        <li class=\"divider\"></li>\n                        <li>\n                            <a href=\"#\">\n                                <div>\n                                    <i class=\"fa fa-envelope fa-fw\"></i> Message Sent\n                                    <span class=\"pull-right text-muted small\">4 minutes ago</span>\n                                </div>\n                            </a>\n                        </li>\n                        <li class=\"divider\"></li>\n                        <li>\n                            <a href=\"#\">\n                                <div>\n                                    <i class=\"fa fa-tasks fa-fw\"></i> New Task\n                                    <span class=\"pull-right text-muted small\">4 minutes ago</span>\n                                </div>\n                            </a>\n                        </li>\n                        <li class=\"divider\"></li>\n                        <li>\n                            <a href=\"#\">\n                                <div>\n                                    <i class=\"fa fa-upload fa-fw\"></i> Server Rebooted\n                                    <span class=\"pull-right text-muted small\">4 minutes ago</span>\n                                </div>\n                            </a>\n                        </li>\n                        <li class=\"divider\"></li>\n                        <li>\n                            <a class=\"text-center\" href=\"#\">\n                                <strong>See All Alerts</strong>\n                                <i class=\"fa fa-angle-right\"></i>\n                            </a>\n                        </li>\n                    </ul>\n                </li>\n                <li class=\"dropdown\">\n                    <a href=\"#\" class=\"dropdown-toggle\" data-toggle=\"dropdown\" role=\"button\" aria-expanded=\"false\"><i class=\"fa fa-tasks fa-fw\"></i> <i class=\"fa fa-caret-down\"></i></a>\n                    <ul class=\"dropdown-menu dropdown-tasks\" role=\"menu\" style=\"width: 250px;\">\n                        <li>\n                            <a href=\"#\">\n                                <div>\n                                    <p>\n                                        <strong>Task 2</strong>\n                                        <span class=\"pull-right text-muted\">20% Complete</span>\n                                    </p>\n                                    <div class=\"progress progress-striped active\">\n                                        <div class=\"progress-bar progress-bar-info\" role=\"progressbar\" aria-valuenow=\"20\" aria-valuemin=\"0\" aria-valuemax=\"100\" style=\"width: 20%\">\n                                            <span class=\"sr-only\">20% Complete</span>\n                                        </div>\n                                    </div>\n                                </div>\n                            </a>\n                        </li>\n                        <li class=\"divider\"></li>\n                        <li>\n                            <a href=\"#\">\n                                <div>\n                                    <p>\n                                        <strong>Task 3</strong>\n                                        <span class=\"pull-right text-muted\">60% Complete</span>\n                                    </p>\n                                    <div class=\"progress progress-striped active\">\n                                        <div class=\"progress-bar progress-bar-warning\" role=\"progressbar\" aria-valuenow=\"60\" aria-valuemin=\"0\" aria-valuemax=\"100\" style=\"width: 60%\">\n                                            <span class=\"sr-only\">60% Complete (warning)</span>\n                                        </div>\n                                    </div>\n                                </div>\n                            </a>\n                        </li>\n                        <li class=\"divider\"></li>\n                        <li>\n                            <a href=\"#\">\n                                <div>\n                                    <p>\n                                        <strong>Task 4</strong>\n                                        <span class=\"pull-right text-muted\">80% Complete</span>\n                                    </p>\n                                    <div class=\"progress progress-striped active\">\n                                        <div class=\"progress-bar progress-bar-danger\" role=\"progressbar\" aria-valuenow=\"80\" aria-valuemin=\"0\" aria-valuemax=\"100\" style=\"width: 80%\">\n                                            <span class=\"sr-only\">80% Complete (danger)</span>\n                                        </div>\n                                    </div>\n                                </div>\n                            </a>\n                        </li>\n                        <li class=\"divider\"></li>\n                        <li>\n                            <a class=\"text-center\" href=\"#\">\n                                <strong>See All Tasks</strong>\n                                <i class=\"fa fa-angle-right\"></i>\n                            </a>\n                        </li>\n                    </ul>\n                </li>\n                <li class=\"dropdown\">\n                    <a href=\"#\" class=\"dropdown-toggle\" data-toggle=\"dropdown\" role=\"button\" aria-expanded=\"false\">Dropdown <span class=\"caret\"></span></a>\n                    <ul class=\"dropdown-menu\" role=\"menu\">\n                        <li><a href=\"#\">Action</a></li>\n                        <li><a href=\"#\">Another action</a></li>\n                        <li><a href=\"#\">Something else here</a></li>\n                        <li class=\"divider\"></li>\n                        <li><a href=\"#\">Separated link</a></li>\n                        <li class=\"divider\"></li>\n                        <li><a href=\"#\">One more separated link</a></li>\n                    </ul>\n                </li>\n                <li><a href=\"#\" onclick=\"logout()\"><i class=\"fa fa-sign-out fa-2x\" aria-hidden=\"true\"></i></a></li>\n            </ul>\n        </div>\n    </div>\n</nav>\n";
...
/***/ function(module, exports) {
	...
	exports['default'] = function (nga, admin) {
	    return nga.menu().addChild(nga.menu().title('Customers').icon('<span class="fa fa-users fa-fw"></span>').active(function (path) {
	        return path.indexOf('/users') === 0;
	    }) // active() is the function that determines if the menu is active
	    .addChild(nga.menu().title('Customers').link('/users/list') // use the same entity list for several menu items
	    .icon('<span class="fa fa-user fa-fw"></span>')).addChild(nga.menu().title('Addresses').link('/addresses/list') // this state isn't handled by ng-admin - no problem
	    .active(function (path) {
	        return path == '/addresses';
	    }).icon('<span class="fa fa-map fa-fw"></span>'))).addChild(nga.menu().title('Sales').icon('<span class="fa fa-shopping-cart fa-fw"></span>').active(function (path) {
	        return path.indexOf('/orders') === 0;
	    }).addChild(nga.menu(admin.getEntity('orders')).icon('<span class="fa fa-shopping-cart fa-fw""></span>')).addChild(nga.menu(admin.getEntity('payments')).icon('<span class="fa fa-credit-card fa-fw""></span>'))).addChild(nga.menu().title('Catalog').icon('<span class="fa fa-th-list fa-fw"></span>').addChild(nga.menu(admin.getEntity('products')) // nga.menu(entity) sets defaults title, link and active values correctly
	    .icon('<span class="fa fa-picture-o fa-fw"></span>')).addChild(nga.menu(admin.getEntity('productsVariants')) // nga.menu(entity) sets defaults title, link and active values correctly
